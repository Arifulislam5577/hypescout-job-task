      ...
      <form className="lg:col-span-4 w-full ">
        ...
        <div className="relative">
          ...
          <input
            type="search"
            id="default-search"
            className="block py-2.5 pl-10 w-full text-base text-gray-900 bg-white rounded  border border-gray-300 focus:ring-primaryBlue focus:border-primaryBlue dark:bg-primaryDark dark:border-gray-600 dark:placeholder-primaryLight placeholder:text-sm dark:text-primaryLight dark:focus:ring-primaryBlue dark:focus:border-primaryBlue"
